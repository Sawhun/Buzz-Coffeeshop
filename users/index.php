...
<html lang="en">
    ...
    <body>
        ...
        <section class="home" id="home">
            <div class="content">
                <h3>Welcome to Buzz Coffee Shop, <?php echo $_SESSION['username']; ?>!</h3>
                <p>
                    <strong>We are open 10:00 AM to 8:00 PM.</strong>
                </p>
        ...
        <section class="footer">
            <div class="footer-container">
                ...
                <div class="credit">
                    <hr /><br/>
                    <h2>BUZZ Brewed Coffee © 2023 | All Rights Reserved.</h2>
