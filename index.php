...
<html lang="en">
    <head>
        ...
        <title>Buzz Brewed Coffee Shop</title>
    ...
    <body>
        ...
        <header class="header">
            <a href="#" class="logo">
                <img src="assets/images/buzz.png" class="img-logo" alt="KapeTann Logo">
            </a>
        ...
        <section class="home" id="home">
            <div class="content">
                <h3>Welcome to Buzz Coffee Shop, Buzz Up!</h3>
                <p>
                    <strong>We are open 10:00 PM to 8:00 PM.</strong>
                </p>
                    ...
                    <div class="row testimonialsRow">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <p>
                                This coffee shop offers a warm and inviting ambiance, 
                                making it a perfect retreat for coffee enthusiasts. 
                                The cozy interior, comfortable seating, and soothing background music
                                create a welcoming environment for customers to relax and enjoy their favorite brew.
                                </p>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/quote-img.png" alt="" class="quote">
                                <p>
                                Enjoy the convenience of a user-friendly website that makes ordering your favorite brew a breeze, 
                                with secure transactions and efficient delivery to your doorstep.
                                </p>
        ...
        <section class="contact" id="contact">
            ...
            <div class="row">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1766.17884319553!2d85.32869709936959!3d27.70624048726067!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb190a74aa1f23%3A0x74ebef82ad0e5c15!2sSoftwarica%20College!5e0!3m2!1sen!2snp!4v1706638258248!5m2!1sen!2snp" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        ...
        <section class="footer">
            <div class="footer-container">
                <div class="logo">
                    ...
                    <p>Sahan@gmail.com</p><br />
                    <i class="fas fa-phone"></i>
                    <p>+977 9841111111</p><br />
                ...
                <div class="credit">
                    <hr /><br/>
                    <h2>BUZZ Brewed Coffee © 2024 | All Rights Reserved.</h2>
                    <h2>Designed by <span>Sahan Bhasima</span> | Softwarican</h2>
                </div>
            </div>
        </section>
